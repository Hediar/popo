...
│           │                 │                 │          │
│  ┌────────▼──────┐  ┌───────▼──────┐  ┌──────▼──────┐ │
│  │ OpenAIService │  │ Supabase     │  │ Admin       │ │
│  │ (LLM/임베딩)  │  │ Service      │  │ Service     │ │
│  │               │  │ (벡터 검색)   │  │ (초기화)    │ │
│  └───────────────┘  └──────────────┘  └─────────────┘ │
└─────────────────────────────────────────────────────────┘
                          │
  ...
  "experiences": [
    {
      ...
      "position": "백엔드 개발자",
      "period": "2022.01 ~ 2023.12",
      "description": "Spring Boot와 JPA를 활용...",
      "tech_stack": ["Spring Boot", "JPA", "Redis"]
    }
  ],
  "projects": [
    {
      "title": "전자상거래 플랫폼",
      "description": "Spring Boot 기반 MSA...",
      "period": "2022.06 ~ 2022.12",
      "tech_stack": ["Spring Boot", "Kafka", "Docker"],
      "role": "백엔드 리드"
    }
  ],
  "skills": [
    {
      "category": "Backend",
      "items": ["Java", "Spring Boot", "JPA", "Redis"]
    }
  ]
}
```
...
{
  "success": true,
  "message": "이력서 데이터가 성공적으로 등록되었습니다.",
  "sectionsCreated": 15
}
```
